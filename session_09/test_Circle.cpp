...
#include "Sphere.h"   // include the Sphere class definition
...
main ()
{
  ...
  cout << "radius = " << my_radius << ", area = " << my_area << ", circumference = " << my_circumference << endl;

  Sphere my_sphere(my_radius); // create a sphere object

  double my_volume = my_sphere.volume();
  cout << "For a sphere of the same radius, the volume would equal " << my_volume << endl;
