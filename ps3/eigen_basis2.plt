...
plot "eig_b2_N_1.out" using ($1):($2) title 'b=2,N=1', \
"eig_b2_N_5.out" using ($1):($2) title 'b=2,N=5', \
"eig_b2_N_10.out" using ($1):(-($2)) title 'b=2,N=10', \
"eig_b2_N_20.out" using ($1):($2) title 'b=2,N=20', \
"eig_b6_N_1.out" using ($1):($2) title 'b=6,N=1', \
"eig_b6_N_5.out" using ($1):($2) title 'b=6,N=5', \
"eig_b6_N_10.out" using ($1):($2) title 'b=6,N=10', \
"eig_b6_N_20.out" using ($1):(-($2)) title 'b=6,N=20'

# output the plot to the file derivative_test_plt.ps   
set out "eigen_basis_b_2and6.ps"
