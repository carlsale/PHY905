...
double disc = pow (b * b - 4. * a * c, 0.5); // definition of discriminant

double x1 = (-b + disc) / (2. * a);      // first root, standard formula 
double x1p = -2. * c / (b + disc);    // first root, new formula
double x2 = (-b - disc) / (2. * a);        // second root, standard formula 
double x2p = (-2. * c) / (b - disc);   // second root, new formula 

cout << "     first root             second root  " << endl;
 cout << fixed << setprecision (30) << x1 << "   " << x2 << endl;
cout << fixed << setprecision (30) << x1p << "   " << x2p << endl;
